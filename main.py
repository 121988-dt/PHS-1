...
#def mission_B():
    ...
    #Flight plan for 9 waypoints    
        ...
        if WPP[9] == 'A':
            ...
            print('O')
        send("go " + str(XXX[10]-XXX[9]) + " " + str(YYY[10]-YYY[9]) + " " + str(ZZZ[10]-ZZZ[9]) + " " + str(100), 5)
    ...
    #Flight plan for 10 waypoints    
        ...
        if WPP[10] == 'A':
            ...
            print('O')
        send("go " + str(XXX[11]-XXX[10]) + " " + str(YYY[11]-YYY[10]) + " " + str(ZZZ[11]-ZZZ[10]) + " " + str(100), 5)
